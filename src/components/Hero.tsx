...
import { Github, Linkedin, Youtube, GraduationCap, Code2, Database, Brain, Cpu, Globe, ArrowDown } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="space-y-8 animate-fade-in text-center lg:text-left" style={{ animationDelay: "0.4s" }}>
              ...
              <div className="flex flex-wrap gap-3 justify-center lg:justify-start">
                ...
                >
                  <svg className="w-4 h-4" viewBox="0 0 256 256" fill="#A6CE39">
              ...
              <div className="pt-4">
                <Button 
                  ...
                  size="lg" 
                  className="text-lg px-8 py-6 rounded-full bg-white text-primary border-2 border-primary hover:bg-primary hover:text-white shadow-lg hover:shadow-xl transition-all hover:scale-105"
                >
                  Explore My Work
