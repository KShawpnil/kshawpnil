    ...
    <section className="relative min-h-screen flex items-center justify-center bg-background overflow-hidden pt-8 pb-16">
      <div className="container mx-auto px-6 py-6">
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-8 items-center justify-items-center min-h-[500px]">
            
            {/* Left - PORT */}
            <div className="flex items-center justify-end w-full animate-fade-in">
            ...
            {/* Right - FOLIO */}
            <div className="flex items-center justify-start w-full animate-fade-in" style={{ animationDelay: "0.1s" }}>
              <h2 className="text-[4rem] md:text-[6rem] lg:text-[8rem] font-black text-accent/20 leading-none tracking-tight">
                FOLIO
              </h2>
            </div>
